    ...
    <div>
        <div className="flex flex-col lg:flex-row gap-20 mb-20 items-center">
            ...
            <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
                ...
                {/* Green card */}
                <div className="absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700 top-0 lg:top-auto
                flex lg:flex-row flex-col rounded-2xl text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10">
