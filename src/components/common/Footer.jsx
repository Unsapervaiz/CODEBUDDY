          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="flex gap-3 text-lg duration-200">
                ...
                <a href="https://x.com/thatsoastha">
                  <svg 
                    className="w-5 cursor-pointer hover:scale-95" 
                    xmlns="http://www.w3.org/2000/svg" 
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              <span> Made with 🤍 </span>
               {" "}
              <Link to='https://www.linkedin.com/in/astha-sahani/' target="__blank" className="text-brown-100 hover:underline mr-1"
              >
                Astha Sahani
              </Link>
            </div>
            <span> © 2024 CodeBuddy</span>
          </div>

          <div className="flex items-center">
            <a href="https://www.linkedin.com/in/astha-sahani/" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </a>
            <a href="https://github.com/Astha86" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </a>
            <a href="https://twitter.com/thatsoastha" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImTwitter size={17} />
            </a>
          </div>
